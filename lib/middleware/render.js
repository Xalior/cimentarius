...
function _render(view, options, fn, templatePack, viewMode, res) {
...
function render(view, options, fn, templatePack, viewMode) {
    ...
    _render(view, options, fn, templatePack, viewMode, that);
}
...
function renderAdmin(view, options, templatePack) {
    ...
    _render(view, options, fn, templatePack, 'admin', that);
}

...
var particleTypeModels = {};

// Populate Particle Type Models
var populateParticleTypeModels = (function () {
    // Get Directory Contents
    var models = fs.readdirSync(__dirname + '/particles');
    // Iterate
    models.forEach(function(item, key) {
        // Check
        if (item.endsWith('.js')) {
            // Add
            particleTypeModels[item.replace('.js', '')] = item;
        }
    });
})();
